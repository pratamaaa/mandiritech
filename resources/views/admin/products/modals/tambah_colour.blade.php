<!-- Modal Tambah Produk -->
<div class="modal fade" id="addProductModalColour" tabindex="-1" aria-labelledby="addProductModalColourLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('produk.basic.store') }}" method="POST" enctype="multipart/form-data" class="modal-content">
            @csrf
            <div class="modal-header">
                <h5 class="modal-title" id="addProductModalColourLabel">Tambah Produk Colour Vu</h5>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <input type="hidden" name="category" value="colourvu">
