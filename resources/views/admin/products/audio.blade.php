...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Produk Kategori CCTV Audio</h2>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addProductModalAudio">
    ...
    @include('admin.products.modals.tambah_audio')
    {{-- @include('admin.products.modals.edit_audio') --}}
@endsection
